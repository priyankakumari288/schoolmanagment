...
$id = $_GET['id'];
$sql = "select * from principalhome where id='$id'";
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-8"> <input type="text" class="form-control" value="<?php echo $row['heading'] ?>" name="heading"> </div>
                                </div>
                            </div>
                            <div class=" col-md-6 mb-4 ">
                                <div class=" row">
                                    <div class="col-md-4 "> <label>Title </label> </div>
                                    <div class="col-md-8"> <input type=" text" class="form-control" name="title" value="<?php echo $row['title'] ?>" > </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-8"><textarea name="paragraph"  id="" cols="5" rows="5" class="form-control"><?php echo $row['paragraph'] ?></textarea></div>
                                </div>
                            </div>
                            <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                        </div>
                        <center><button class="btn btn-success btn-sm" type="submit" name="homeprincipal_update">Submit</button> </center> <br><br>
                    </form>
