    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <div class="row">
                <div class="col-md-3 mb-3"></div>
                    <div class="col-md-3 mb-3"><label> DOB:</label></div>
                    <div class="col-md-3 mb-3"><input type="text" name="dob" id="up_dob" value="<?= $row['admissiondate']; ?>" class=" form-control"></div>
                    <div class="col-md-3 mb-3"></div>
                </div>
                <input type="hidden" class="form-control email" id="id" name="id" value="<?= $row['id']; ?>" aria-describedby="emailHelp" placeholder="Enter email">
<br><br>
                <center><button type="button" class="btn btn-primary" onclick="up_sessionwize()" name="update_form">Update</button></center>
        ...
        function up_sessionwize() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    up_dob: up_dob,
                    update_sessionsearch: 'update_sessionsearch'
                },
                success: function(result) {
                    // alert(result);
                    if (result == 1) {

                        window.location.href = "sessionwise.php";
