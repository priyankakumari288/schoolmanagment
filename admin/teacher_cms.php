          ...
          <form action="actionn.php" method="post" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class=" col-md-6 mb-4 ">
                    ...
                    <div class="col-md-8"> <input type=" text" class="form-control" name="qualification"></div>
                  </div>
                </div>
              <div class=" col-md-6 mb-4 ">
                    <div class=" row">
                    <div class="col-md-4 "> <label>Designation: </label> </div>
                    <div class="col-md-8"> <input type=" text" class="form-control" name="designation"></div>
                  </div>
                </div>
              ...
              <center><button class="btn btn-success btn-sm" type="submit" name="teacher">Submit</button> </center> <br><br>
          </form>
              ...
              <tbody>
                ...
                ?>
                  <tr class="text-center">
                    ...
                    <td> <a href="actionn.php?teachersid=<?php echo $row['id']; ?>"><i class="fas fa-trash"></i></a>
                      <a href="teacher_update.php?id=<?php echo $row['id']; ?>" class="text-white"> <i class="fa-solid fa-pen-to-square"></i> </a>
                    </td>
                  </tr>
                <?php
                }
