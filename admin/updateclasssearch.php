...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3"><input type="text" name="fathers" id="up_fathers" value="<?= $row['fathers']; ?>" class=" form-control"></div>
                    <div class="col-md-3 mb-3"></div>
                </div>
                <div class="row">
                    <div class="col-md-3 mb-3"></div>
                ...
                <div class="row">
                    <div class="col-md-3 mb-3"></div>
                    <div class="col-md-3 mb-3"><label> Mobile No.:</label></div>
                    <div class="col-md-3 mb-3"><input type="text" name="mobile" id="up_mobile" value="<?= $row['mobile']; ?>" class=" form-control"></div>
                    <div class="col-md-3 mb-3"></div>
                </div>
                <input type="hidden" class="form-control email" id="id" name="id" value="<?= $row['id']; ?>" aria-describedby="emailHelp" placeholder="Enter email">
                <br><br>
                <center><button type="button" class="btn btn-primary" onclick="up_classwisesearch()" name="update_form">Update</button></center>
    ...
    <!-- /.control-sidebar -->
    <script>
        function up_classwisesearch() {
            // debugger;
            var id = $('#id').val();
            var up_adm = $('#up_adm').val();
            var up_name = $('#up_name').val();
            var up_fathers = $('#up_fathers').val();
            ...
            $.ajax({
                ...
                data: {
                    ...
                    up_name: up_name,
                    up_fathers: up_fathers,
                    up_date: up_date,
                    up_session: up_session,
                    up_class: up_class,
                    up_mobile: up_mobile,
                    update_classsearch: 'update_classsearch'
                },
                success: function(result) {
                    // alert(result);
                    if (result == 1) {
                        window.location.href = "classwise.php";
                    }
                }
            });
        }
