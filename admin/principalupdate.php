...
$id = $_GET['id'];
$sql = "select * from principaldesk where id='$id'";
            ...
            <section class="deaals">
                <div class="container">
                    ...
                    <form action="actionn.php" method="post" enctype="multipart/form-data">
                        ...
                        <center><button class="btn btn-success btn-sm" type="submit" name="principal_update">Submit</button> </center> <br><br>
                    </form>
