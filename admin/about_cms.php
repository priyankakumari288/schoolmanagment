                    ...
                    <form action="actionn.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <center><button class="btn btn-success btn-sm" type="submit" name="aboutcms">Submit</button> </center> <br><br>
                    </form>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="text-center">
                                        ...
                                        <td> <a href="actionn.php?aboutusid=<?php echo $row['id']; ?>"><i class="fas fa-trash"></i> </a>
                                            <a href="about_update.php?id=<?php echo $row['id']; ?>" class="text-white" name="upda"><i class="fa-solid fa-pen-to-square"></i></a>
                                        </td>
                                    </tr>
                                <?php
                                }
