...
<!-- <div class="container-fluid bg-primary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
            <h3 class="display-3 font-weight-bold text-white">Principal Desk</h3>
            <div class="d-inline-flex text-white">
                <p class="m-0"><a class="text-white" href="">Home</a></p>
                <p class="m-0 px-2">/</p>
                <p class="m-0">About Us</p>
                <p class="m-0 px-2">/</p>
                <p class="m-0">Principal Desk</p>
            </div>
        </div>
    </div> -->
...
<div class="container-fluid py-5">
    <div class="container py-5">
        ...
        <?php 
                ...
                ?>  
            <div class="col-lg-3">
                <img class="abouti img-fluid rounded mb-4 mb-lg-0 img-thumbnail" src="admin/uploads/<?php echo $row['image']; ?>" style="height:300px; width:300px" alt="">
            </div>
            <div class="col-lg-9">
